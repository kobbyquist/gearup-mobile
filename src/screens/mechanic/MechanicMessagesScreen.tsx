...
const MOCK_CONVERSATIONS = [
  { id: 1, name: 'Ama Owusu', role: 'Car Owner', lastMessage: 'How long will it take?', time: '5m ago', unread: 1, avatar: 'A' },
  { id: 2, name: 'Kweku Darko', role: 'Car Owner', lastMessage: 'Thank you so much!', time: '30m ago', unread: 0, avatar: 'K' },
  { id: 3, name: 'Abena Mensah', role: 'Car Owner', lastMessage: 'Can you come to East Legon?', time: '3h ago', unread: 0, avatar: 'A' },
];
    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.list}>
        {MOCK_CONVERSATIONS.map(convo => (
          <TouchableOpacity key={convo.id} style={styles.convoCard}>
            <View style={styles.avatarContainer}>
              <LinearGradient colors={['#b45309', '#78350f']} style={styles.avatar}>
        ...
        <View style={styles.comingSoon}>
          ...
          <Text style={styles.comingSoonText}>Full in-app chat with car owners will be available in the next update.</Text>
        </View>
      </ScrollView>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  convoRole: { fontSize: FONT_SIZES.xs, color: '#b45309', fontWeight: '600', marginBottom: 2 },
  convoMessage: { fontSize: FONT_SIZES.sm, color: '#6b7280' },
  unreadBadge: { backgroundColor: '#b45309', width: 20, height: 20, borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginLeft: SPACING.sm },
