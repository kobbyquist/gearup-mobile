      ...
      <View style={styles.infoCard}>
        ...
        {routeInfo && (
          <View style={styles.routeInfoRow}>
            ...
            <Ionicons name="speedometer-outline" size={14} color="#b45309" style={{ marginLeft: 10 }} />
        ...
        <TouchableOpacity
          ...
          <LinearGradient colors={['#b45309', '#78350f']} style={styles.directionsGradient}>
            {fetchingRoute ? (
...
const styles = StyleSheet.create({
  ...
  mechanicPin: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#b45309', justifyContent: 'center', alignItems: 'center', borderWidth: 3, borderColor: '#fff', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 4, elevation: 4 },
  ...
  routeInfoText: { fontSize: FONT_SIZES.sm, fontWeight: '700', color: '#b45309', marginLeft: 4 },
